...
|  |  |  |
|:---:|:---:|:---:|
| [![Bugs](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=bugs)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) | [![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=code_smells)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) | [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=coverage)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) |
| [![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=duplicated_lines_density)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) | [![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=ncloc)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) | [![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) |
| [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=alert_status)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) | [![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=DamienToomey_memory&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) | [![SonarCloud](https://sonarcloud.io/images/project_badges/sonarcloud-white.svg)](https://sonarcloud.io/dashboard?id=DamienToomey_memory) |
